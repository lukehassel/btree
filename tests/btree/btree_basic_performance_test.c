/**
 * btree_basic_performance_test.c
 *
 * A basic performance test for the pthread B+ Tree implementation
 * focusing on small, safe operations.
 */
...
int main() {
    printf("🚀 Basic B+ Tree Performance Test Suite\n");
    printf("=======================================\n\n");
    
    printf("Testing pthread B+ Tree implementation with safe operations...\n\n");
    ...
    printf("🎯 Basic Performance Test Suite Complete!\n");
